...
const MemoryContext: React.FC<MemoryContextProps> = ({ x, y, closeContextMenu, filePath }) => {
    ...
    return (
        <>
            <Context
                ...
                className="w-56 bg-sidebar shadow-2xl rounded-md border-solid border-[1px] border-border"
            >
                <div className="flex flex-col items-center justify-center p-1">
                    ...
                    <button onClick={renameFile} className="w-full h-8 flex items-center justify-start gap-2 px-4 rounded-md transition-colors-fast hover:bg-header">
                        <LuPencil className="text-[14px] text-neutral-300" />
                        <p className="text-neutral-300 text-[12px]">Edit</p>
                    </button>
                </div>
